								...
								<div class="widget-body">
									<div class="widget-main">
										<table class="searchField" style="margin: 4px; padding: 4px;">
											<tr>
												<td>账号：</td>
												<td><input type="text" style="width:100px;" id="txtUsername" class="form-control input-small" placeholder=""
												...
												<td>身份证号：</td>
												<td><input type="text" id="idnum" class="form-control input-large" placeholder=""
														   value="${sysUserSearchVO.idnum }"></td>
												<td>状态：</td>
