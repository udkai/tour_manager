			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							模块管理 <small> <i class="ace-icon fa fa-angle-double-right"></i> 新增功能
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							<form id="userForm" name="userForm" class="form-horizontal" action="${dynamicServer }/sys/function/add.htm" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input id="code" type="text" name="code" maxlength="30" class="col-xs-10 col-sm-5" placeholder="" value=""><label id="codeTip"></label>
									</div>
								</div>
								<div class="form-group">
