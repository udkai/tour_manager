                    ...
                    <div class="col-xs-12">
                        <form id="roleForm" name="roleForm" class="form-horizontal" action="add.htm" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input id="description" maxlength="100" type="text" name="description" class="col-xs-10 col-sm-5"
                                            ...
                                            <div class="widget-box">
                                                ...
                                                <div class="widget-header">
                                                    <h4 class="widget-title">
                                                        <label> <input name="module" class="ace father" type="checkbox"
                                                                       ...
                                                                       value="${sysModule.id }"/> <span
                                                                class="lbl">${sysModule.name }</span>
                                                        </label>
                                                    </h4>
                                                ...
                                                <div class="widget-body">
                                                    <div class="widget-main">
                                                        <c:forEach items="${listModule }" var="secModule"
                                                                   varStatus="st">
                                                            <c:if test="${sysModule.id eq secModule.parent_id }">
                                                                <label> <input name="module" id="mod_${secModule.id }"
                                                                               ...
                                                                               class="ace children"/> <span
                                                                        class="lbl"> ${secModule.name}</span>
                                                                </label>
                                                                    ...
                                                                    <c:if test="${sysFunction.module_id eq secModule.id }">
                                                                        <label class="checkbox inline"
                                                                               style="color: blue"><input
                                                                                name="function"
                                                                                id="function_${sysFunction.id }"
                                                                                type="checkbox"
                                                                                value="${sysFunction.id }"
                                                                                class="ace children"/> <span
                                                                                class="lbl"> ${sysFunction.name }</span>
                                                                        </label>
                                                                    </c:if>
                                                                </c:forEach>
                                                                <br/>
